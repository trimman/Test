...
jQuery.sap.declare("SCV_test1.Component");
jQuery.sap.require("sap.ui.core.UIComponent");
jQuery.sap.require("sap.ui.core.routing.History");
jQuery.sap.require("sap.m.routing.RouteMatchedHandler");

sap.ui.core.UIComponent.extend("SCV_test1.Component", {
    metadata : {
        "name" : "SCV_test1",
		...
		"config" : {
			...
			serviceConfig : {
				name: "ZCATALOG_SRV",
				serviceUrl: "/sap/opu/odata/sap/ZCATALOG_SRV/"
			}
		},
        routing : {
    ...
    init : function() {
        ...
        var sRootPath = jQuery.sap.getModulePath("SCV_test1");
    ...
    _initODataModel : function(sServiceUrl) {
        jQuery.sap.require("SCV_test1.util.messages");
        var oConfig = {
            metadataUrlParams : {},
            json : true,
        ...
        oModel.attachRequestFailed(null, SCV_test1.util.messages.showErrorMessage);
