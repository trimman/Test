jQuery.sap.declare("SCV_test1.util.messages");
jQuery.sap.require("sap.ca.ui.message.message");

SCV_test1.util.messages = {};
 ...
 * @public
 */
SCV_test1.util.messages.showErrorMessage = function(oParameter) {
	var oErrorDetails = SCV_test1.util.messages._parseError(oParameter);
...
SCV_test1.util.messages.getErrorContent = function(oParameter) {
	return SCV_test1.util.messages._parseError(oParameter).sMessage;
};

SCV_test1.util.messages._parseError = function(oParameter) {
	var sMessage = "",
		sDetails = "",
		oEvent = null,
		oResponse = null,
